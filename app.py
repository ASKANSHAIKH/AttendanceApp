...
# --- 4. INITIALIZATION (Fixes Table Errors) ---
def init_app():
    # This automatically creates the missing tables
...
def get_address(lat, lon):
    try:
        ...
        return loc.address.split(",")[0] + ", " + loc.address.split(",")[-4] if loc else "Unknown"
